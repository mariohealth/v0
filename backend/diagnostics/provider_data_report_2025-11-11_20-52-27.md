# Mario Health Provider Data Diagnostics — 2025-11-11_20-52-27
...
2. **Fix orphan records**: Address 985 pricing records that reference non-existent providers
3. **Increase pricing coverage**: Only 0.3% of providers have pricing data
