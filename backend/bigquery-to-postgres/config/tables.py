...
TABLES = {
    'billing_code_nucc_specialty_map': {
        'bigquery_table': 'billing_code_nucc_specialty_map',
        'postgres_table': 'billing_code_nucc_specialty_map',
        'required_columns': ['billing_code_type',
                             'billing_code',
                             'taxonomy_id'],
    ...
    'bundle_group_codes': {
        'bigquery_table': 'bundle_group_codes',
        'postgres_table': 'bundle_group_codes',
        'primary_key': 'id',
        'required_columns': ['bundle_group_id',
                             'code_id',
                             'frequency',
                             'is_default',
                             'display_order',
    ...
    'bundle_groups': {
        'bigquery_table': 'bundle_groups',
        'postgres_table': 'bundle_groups',
        'primary_key': 'id',
        'required_columns': ['bundle_id',
                             'name',
                             'selection_type',
                             'display_order',
                             'is_required',
    ...
    'bundles' : {
        'bigquery_table': 'bundles',
        'postgres_table': 'bundles',
        'primary_key': 'id',
    ...
    'codes': {
        'bigquery_table': 'codes',
        'postgres_table': 'codes',
        'primary_key': 'id',
    ...
    'code_pricing': {
        'bigquery_table': 'code_pricing',
        'postgres_table': 'code_pricing',
    ...
    'code_pricing_facility_agg': {
        'bigquery_table': 'code_pricing_facility_agg',
        'postgres_table': 'code_pricing_facility_agg',
        'required_columns': ['carrier_id',
                             'carrier_plan_id',
                             'hospital_id',
                             'billing_code',
                             'billing_code_type',
                             ...
                             'count_rows',
                             'count_distinct_npi',
                             'min_professional_rate',
                             'avg_professional_rate',
                             'max_professional_rate',
                             'min_institutional_rate',
                             'avg_institutional_rate',
                             'max_institutional_rate',
                             'min_total_rate',
                             'avg_total_rate',
                             'max_total_rate'],
        'sync_mode': 'full_refresh',
