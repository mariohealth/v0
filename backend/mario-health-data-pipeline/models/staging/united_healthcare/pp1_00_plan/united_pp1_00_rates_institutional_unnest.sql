...
-- This table has one row per billing code per provider group ID for institutional rates only.
...
t1 AS (
  ...
  WHERE prices.billing_class = 'institutional' -- institutional rates only
